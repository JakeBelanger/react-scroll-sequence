...
exports.createLoadingQueue = void 0;
exports.drawImageCover = drawImageCover;

require("core-js/modules/es.array.sort.js");

const createLoadingQueue = l => [0, l >> 1, l - 1].concat(Array(l).fill(0).map((_, i) => i).sort((e, n) => e % 5 - n % 5));
/**
...
exports.createLoadingQueue = createLoadingQueue;
